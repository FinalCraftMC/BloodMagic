...
//		AlchemicalWizardry.lockdownAltar = config.get("WimpySettings", "LockdownAltarWithRegen", true).getBoolean();
		...
		AlchemicalWizardry.ritualWeakDisabledNight = false;//config.get("Ritual Blacklist.Weak", "Night", false).getBoolean(false);
		AlchemicalWizardry.ritualWeakDisabledResistance = config.get("Ritual Blacklist.Weak", "Resistance", false).getBoolean(false);
		AlchemicalWizardry.ritualWeakDisabledThunderstorm = false;//config.get("Ritual Blacklist.Weak", "Thunderstorm", false).getBoolean(false);
